      ...
      <Box sx={{
        ...
        <Box sx={{ maxWidth: 480, textAlign: 'center', zIndex: 2 }}>
          ...
          <Typography sx={{ color: 'rgba(255, 255, 255, 0.85)', mb: 6, fontSize: '1.1rem', fontWeight: 500 }}>
            Set up your account in seconds and start exchanging ideas, photos, and feedback with creators.
          </Typography>
          ...
          <Card sx={{
            ...
            <Box display="flex" alignItems="center" gap={2} mb={2}>
              ...
              <Box>
                <Typography fontWeight="700" fontSize={15} color="#fff">Marcus Aurelius</Typography>
                <Typography fontSize={12} color="rgba(255,255,255,0.7)">@marcus · 1h ago</Typography>
              </Box>
            </Box>
            <Typography fontSize={14.5} color="rgba(255,255,255,0.95)" lineHeight={1.6} mb={2.5}>
              Loving the simplicity of posting and commenting here. The clean typography and modern look make interactions feel natural and warm. 🖥️☕
            </Typography>
            <Divider sx={{ borderColor: 'rgba(255,255,255,0.12)', mb: 2 }} />
            <Box display="flex" gap={3} color="rgba(255,255,255,0.8)">
              <Box display="flex" alignItems="center" gap={0.5} fontSize={13}>
                <Favorite sx={{ color: '#f43f5e', fontSize: 18 }} /> 98 Likes
              </Box>
              <Box display="flex" alignItems="center" gap={0.5} fontSize={13}>
                <ChatBubbleOutlineOutlined sx={{ fontSize: 18 }} /> 12 Comments
              </Box>
            </Box>
          </Card>
        </Box>
      ...
      <Box sx={{
        ...
        <Box sx={{ maxWidth: 400, width: '100%', mx: 'auto' }}>
          ...
          <Typography textAlign="center" mt={4} sx={{ color: '#64748b', fontSize: 14 }}>
            ...
            <Link component={RouterLink} to="/login" underline="hover" sx={{ color: '#4f46e5', fontWeight: 700 }}>
              Login
            </Link>
          </Typography>
        </Box>
